...
export function CalorieSummaryRing({ consumed, goal }: Props) {
  ...
  const color = consumed > goal ? "#ef4444" : goal > 0 && consumed / goal >= 0.9 ? "#f59e0b" : "#8b5cf6";
    ...
    <div className="flex flex-col items-center gap-2">
      ...
      <div className="relative w-40 h-40">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
          <span className="text-2xl font-bold text-slate-200" style={{ fontFamily: '"Space Grotesk", sans-serif' }}>{consumed}</span>
