  ...
  return (
    <nav className="fixed bottom-0 inset-x-0 z-50 bg-card/90 backdrop-blur-lg border-t border-border">
      <div className="relative max-w-2xl mx-auto flex items-end justify-around px-2 pb-safe h-16">
        {/* Home — active */}
        <button className="flex flex-col items-center justify-center gap-1 flex-1 h-full" aria-label="Home">
          <Home className="h-5 w-5 text-violet-400" />
        </button>

        {/* Chart */}
        <button className="flex flex-col items-center justify-center gap-1 flex-1 h-full opacity-40" aria-label="Stats" disabled>
        ...
        {/* Heart */}
        <button className="flex flex-col items-center justify-center gap-1 flex-1 h-full opacity-40" aria-label="Favorites" disabled>
          <Heart className="h-5 w-5 text-muted-foreground" />
        </button>

        {/* Profile */}
        <button className="flex flex-col items-center justify-center gap-1 flex-1 h-full opacity-40" aria-label="Profile" disabled>
